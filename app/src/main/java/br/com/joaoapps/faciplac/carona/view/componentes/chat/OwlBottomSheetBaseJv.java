...
public class OwlBottomSheetBaseJv extends FrameLayout {
    ...
    private OnExpandBottomSheetListener onExpandBottomSheetListener;
    ...
    public void setOnExpandBottomSheetListener(OnExpandBottomSheetListener onExpandBottomSheetListener) {
        this.onExpandBottomSheetListener = onExpandBottomSheetListener;
    }

    void expand() {
        if (!isExpanded) {
            if (onExpandBottomSheetListener != null) {
                onExpandBottomSheetListener.onExpand();
            }
            this.initAnimBuilder();
    ...
    public interface OnExpandBottomSheetListener {
        void onExpand();
    }
}
